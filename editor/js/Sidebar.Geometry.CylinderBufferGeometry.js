...
function GeometryParametersPanel(editor, object) {
	...
	radialSegmentsRow.add(
		new UIText(strings.getKey("sidebar/geometry/cylinder_geometry/radialsegments")).setWidth("90px")
	);
	...
	heightSegmentsRow.add(
		new UIText(strings.getKey("sidebar/geometry/cylinder_geometry/heightsegments")).setWidth("90px")
	);
