...
function GeometryParametersPanel(editor, object) {
	...
	curveSegmentsRow.add(
		new UIText(strings.getKey("sidebar/geometry/extrude_geometry/curveSegments")).setWidth("90px")
	);
	...
	if (options.bevelEnabled === true) {
		...
		thicknessRow.add(
			new UIText(strings.getKey("sidebar/geometry/extrude_geometry/bevelThickness")).setWidth("90px")
		);
