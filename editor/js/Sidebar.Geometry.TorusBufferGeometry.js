...
function GeometryParametersPanel(editor, object) {
	...
	radialSegmentsRow.add(
		new UIText(strings.getKey("sidebar/geometry/torus_geometry/radialsegments")).setWidth("90px")
	);
	...
	tubularSegmentsRow.add(
		new UIText(strings.getKey("sidebar/geometry/torus_geometry/tubularsegments")).setWidth("90px")
	);
