...
function GeometryParametersPanel(editor, object) {
	...
	tubularSegmentsRow.add(
		new UIText(strings.getKey("sidebar/geometry/tube_geometry/tubularsegments")).setWidth("90px")
	);
	...
	curveTypeRow.add(
		new UIText(strings.getKey("sidebar/geometry/tube_geometry/curvetype")).setWidth("90px"),
		curveType
	);
