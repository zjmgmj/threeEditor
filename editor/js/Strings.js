function Strings(config) {
	...
	var values = {
		...
		zh: {
			...
			// "sidebar/object/uuid": "识别码(uuid)",
			// "sidebar/object/name": "名称",
			// "sidebar/object/position": "position",
			// "sidebar/object/rotation": "rotation",
			// "sidebar/object/scale": "缩放(scale)",
			// "sidebar/object/fov": "视角(fov)",
			// "sidebar/object/left": "左(left)",
			// "sidebar/object/right": "右(right)",
			// "sidebar/object/top": "上(top)",
			// "sidebar/object/bottom": "下(bottom)",
			// "sidebar/object/near": "近点(near)",
