	...
	MMDAnimationHelper.prototype = {
		...
		_setupCamera: function (camera, params) {
			if (this.camera === camera) {
				throw new Error(
					"THREE.MMDAnimationHelper._setupCamera: " + "Camera '" + camera.name + "' has already been set."
				);
			}
		...
		_setupAudio: function (audio, params) {
			if (this.audio === audio) {
				throw new Error(
					"THREE.MMDAnimationHelper._setupAudio: " + "Audio '" + audio.name + "' has already been set."
				);
			}
		...
		_clearCamera: function (camera) {
			if (camera !== this.camera) {
				throw new Error(
					"THREE.MMDAnimationHelper._clearCamera: " + "Camera '" + camera.name + "' has not been set yet."
				);
			}
		...
		_clearAudio: function (audio) {
			if (audio !== this.audio) {
				throw new Error(
					"THREE.MMDAnimationHelper._clearAudio: " + "Audio '" + audio.name + "' has not been set yet."
				);
			}
