...
class KTX2Container {
	constructor(basisModule, arrayBuffer) {
		...
		if (
			...
			!(this.header.supercompressionScheme === 1 /* BasisLZ */ || this.dfd.colorModel === DFDModel.UASTC)
		) {
	...
	getEncoding() {
		return this.dfd.transferFunction === 2 /* KHR_DF_TRANSFER_SRGB */ ? sRGBEncoding : LinearEncoding;
	}
